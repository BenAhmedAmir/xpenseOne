...
import styles from '../template/assets/jss/nextjs-material-dashboard/layouts/adminStyle.js';
// @ts-ignore
import bgImage from '../template/assets/img/sidebar-1.jpg';
// @ts-ignore
import logo from '../template/assets/img/reactlogo.png';
let ps;
// @ts-ignore
